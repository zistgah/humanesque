...
The Hindawi Indic Programming System for the **BENGALI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | BENGALI → Devanagari hub | `bengali_to_deva.tsv` — 80 rows |
| LANGUAGE | keyword vocabulary | `langs/` — assamese, bengali |
...
10 of 18 language×shaili tables carry native keywords.
