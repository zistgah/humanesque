...
The Hindawi Indic Programming System for the **DEVANAGARI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | DEVANAGARI → Devanagari hub | `devanagari_to_deva.tsv` — 129 rows |
| LANGUAGE | keyword vocabulary | `langs/` — bodo, hindi, konkani, marathi, nepali, sanskrit, prakrit, pali |
...
20 of 54 language×shaili tables carry native keywords.
