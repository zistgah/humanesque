# Hindawi — SYLOTI NAGRI

© 1993–2026 Abhishek Choudhary. AyeAI. GPL-3.0-or-later.

The Hindawi Indic Programming System for the **SYLOTI NAGRI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | SYLOTI NAGRI → Devanagari hub | `syloti_nagri_to_deva.tsv` — 10 rows |
