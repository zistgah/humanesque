# Hindawi — GURUNG KHEMA

© 1993–2026 Abhishek Choudhary. AyeAI. GPL-3.0-or-later.

The Hindawi Indic Programming System for the **GURUNG KHEMA** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | GURUNG KHEMA → Devanagari hub | `gurung_khema_to_deva.tsv` — 1 rows |
