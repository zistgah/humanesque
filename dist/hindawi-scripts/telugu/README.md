...
The Hindawi Indic Programming System for the **TELUGU** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | TELUGU → Devanagari hub | `telugu_to_deva.tsv` — 79 rows |
| LANGUAGE | keyword vocabulary | `langs/` — telugu |
...
6 of 9 language×shaili tables carry native keywords.
