...
The Hindawi Indic Programming System for the **ORIYA** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | ORIYA → Devanagari hub | `oriya_to_deva.tsv` — 81 rows |
| LANGUAGE | keyword vocabulary | `langs/` — odia |
