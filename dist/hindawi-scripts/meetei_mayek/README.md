# Hindawi — MEETEI MAYEK

© 1993–2026 Abhishek Choudhary. AyeAI. GPL-3.0-or-later.

The Hindawi Indic Programming System for the **MEETEI MAYEK** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | MEETEI MAYEK → Devanagari hub | `meetei_mayek_to_deva.tsv` — 29 rows |
| LANGUAGE | keyword vocabulary | `langs/` — manipuri |
