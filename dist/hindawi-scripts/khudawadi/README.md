...
The Hindawi Indic Programming System for the **KHUDAWADI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | KHUDAWADI → Devanagari hub | `khudawadi_to_deva.tsv` — 70 rows |
| LANGUAGE | keyword vocabulary | `langs/` — sindhi |
