...
The Hindawi Indic Programming System for the **GUJARATI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | GUJARATI → Devanagari hub | `gujarati_to_deva.tsv` — 83 rows |
| LANGUAGE | keyword vocabulary | `langs/` — gujarati |
