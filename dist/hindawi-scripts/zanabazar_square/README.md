# Hindawi — ZANABAZAR SQUARE

© 1993–2026 Abhishek Choudhary. AyeAI. GPL-3.0-or-later.

The Hindawi Indic Programming System for the **ZANABAZAR SQUARE** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | ZANABAZAR SQUARE → Devanagari hub | `zanabazar_square_to_deva.tsv` — 48 rows |
