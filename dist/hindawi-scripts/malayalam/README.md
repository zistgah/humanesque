...
The Hindawi Indic Programming System for the **MALAYALAM** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | MALAYALAM → Devanagari hub | `malayalam_to_deva.tsv` — 80 rows |
| LANGUAGE | keyword vocabulary | `langs/` — malayalam |
...
5 of 9 language×shaili tables carry native keywords.
