...
The Hindawi Indic Programming System for the **TAMIL** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | TAMIL → Devanagari hub | `tamil_to_deva.tsv` — 57 rows |
| LANGUAGE | keyword vocabulary | `langs/` — tamil |
