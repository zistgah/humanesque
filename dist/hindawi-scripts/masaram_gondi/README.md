# Hindawi — MASARAM GONDI

© 1993–2026 Abhishek Choudhary. AyeAI. GPL-3.0-or-later.

The Hindawi Indic Programming System for the **MASARAM GONDI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | MASARAM GONDI → Devanagari hub | `masaram_gondi_to_deva.tsv` — 68 rows |
