# Hindawi — GUNJALA GONDI

© 1993–2026 Abhishek Choudhary. AyeAI. GPL-3.0-or-later.

The Hindawi Indic Programming System for the **GUNJALA GONDI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | GUNJALA GONDI → Devanagari hub | `gunjala_gondi_to_deva.tsv` — 59 rows |
