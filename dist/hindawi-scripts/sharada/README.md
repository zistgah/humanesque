...
The Hindawi Indic Programming System for the **SHARADA** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | SHARADA → Devanagari hub | `sharada_to_deva.tsv` — 84 rows |
| LANGUAGE | keyword vocabulary | `langs/` — kashmiri |
