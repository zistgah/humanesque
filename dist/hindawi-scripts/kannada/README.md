...
The Hindawi Indic Programming System for the **KANNADA** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | KANNADA → Devanagari hub | `kannada_to_deva.tsv` — 80 rows |
| LANGUAGE | keyword vocabulary | `langs/` — kannada |
