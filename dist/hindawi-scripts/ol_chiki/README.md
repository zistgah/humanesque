...
The Hindawi Indic Programming System for the **OL CHIKI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | OL CHIKI → Devanagari hub | `ol_chiki_to_deva.tsv` — 12 rows |
| LANGUAGE | keyword vocabulary | `langs/` — santali |
