...
The Hindawi Indic Programming System for the **TIRHUTA** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | TIRHUTA → Devanagari hub | `tirhuta_to_deva.tsv` — 81 rows |
| LANGUAGE | keyword vocabulary | `langs/` — maithili |
