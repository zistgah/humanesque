...
The Hindawi Indic Programming System for the **GURMUKHI** script. Self-contained.

## The three axes, all here

| axis | what | in this bundle |
|---|---|---|
| SCRIPT | GURMUKHI → Devanagari hub | `gurmukhi_to_deva.tsv` — 68 rows |
| LANGUAGE | keyword vocabulary | `langs/` — punjabi |
